import { getCurrentInstance, version, inject, ref, watchEffect, watch, useSSRContext, createApp, reactive, unref, provide, onErrorCaptured, onServerPrefetch, toRef, shallowRef, computed, isReadonly, defineAsyncComponent, isRef, mergeProps, nextTick, defineComponent, h, Suspense, Transition } from 'vue';
...
const components = {
  JBCard: /* @__PURE__ */ defineAsyncComponent(() => import(
    './JBCard-eac42adb.mjs'
    /* webpackChunkName: "components/j-b-card" */
  ).then((c) => c.default || c)),
  JBStat: /* @__PURE__ */ defineAsyncComponent(() => import(
    './JBStat-fce5206b.mjs'
    /* webpackChunkName: "components/j-b-stat" */
  ).then((c) => c.default || c))
};
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./index-500e76a3.mjs').then((m) => m.default || m)
  }
];
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-screen flex flex-col" }, _attrs))}><div class="flex-grow bg-bg-primary">`);
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./error-component-3f794a0e.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./island-renderer-ec670aca.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, useRouter as a, useHead as b, createError as c, entry$1 as default, navigateTo as n, useNuxtApp as u };
